!function(t){
    ...
    t.fn.miniEventCalendar=t.fn.MEC=function(n){
        var a=t.extend({
            calendar_link:"",events:[],from_monday:!1,onMonthChanged:null},n),
            i=this;
            ...
            function c(t,n,d){
                ...
                for(a.from_monday&&(c=h.getDay()>0?h.getDay()-1:6),1===l.getDate()&&v.append(function(t){
                    ...
                    for(var a=function(t,e){
                        ...
                        return a}(e,n),i="",d=t;d>0;d--)i+=g(!0,a[a.length-d]);return i}(c));l.getMonth()===t;){
                    
                    h=new Date(l);var D=m(l,new Date),F=null,w=a.events.findIndex(function(t){return m(h,new Date(t.date))});-1!=w&&(F=a.events[w],d&&D&&p(F)),v.append(g(!1,l.getDate(),D,F,d&&D)),l.setDate(l.getDate()+1);var y=43-i.find(".a-date").length;if(l.getMonth()!=t)for(var x=1;x<y;x++)v.append(g(!0,x))}a.onMonthChanged&&a.onMonthChanged(t,n)}function g(t,e,n,a,i){
                    
                    var d="<div class='a-date blurred'><span>"+e+"</span></div>";if(!t){var v=a&&null!==a,o=n?"current ":"";o+=v&&i?"focused ":"";d="<button type='button' class='a-date "+(o+=v?"event ":"")+"' data-event='"+JSON.stringify(a)+"'><span>"+e+"</span></button>"}return d}function p(t){t&&null!=t?(r.text(t.title),s.text("VIEW EVENT"),s.attr("href",t.link)):(r.text("No events on this day."),s.text("ALL EVENTS"),s.attr("href",a.calendar_link))}function m(t,e){return t.getFullYear()==e.getFullYear()&&t.getMonth()==e.getMonth()&&t.getDate()==e.getDate()}
